...
class Predict(object):
    ...
    def TodayPredict5Day_0517(this):
        ...
        #切换为e
        #cur_fe=FE.FEg30eom0110onlinef()
        cur_fe=FE.FEg30eom0110onlinew5()   
        cur_fe.real_FE()
        ...
        #选择模型
        cur_model=Models.LGBmodel_20()
        cur_model.real_lgb_predict('lgb13.pkl','out1.csv')
        cur_model.real_lgb_predict('lgb23.pkl','out2.csv')
        cur_model.real_lgb_predict('lgb33.pkl','out3.csv')
        cur_model.real_lgb_predict('lgb43.pkl','out4.csv')
